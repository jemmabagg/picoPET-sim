...
X_train = np.load(f"{base_path}/noisy_sinograms_train1.0.npy")
X_val   = np.load(f"{base_path}/noisy_sinograms_val1.0.npy")
X_test  = np.load(f"{base_path}/noisy_sinograms_test1.0.npy")
