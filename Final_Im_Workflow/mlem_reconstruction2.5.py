...
X_train = np.load(f"{base_path}/noisy_sinograms_train2.5.npy")
X_val   = np.load(f"{base_path}/noisy_sinograms_val2.5.npy")
X_test  = np.load(f"{base_path}/noisy_sinograms_test2.5.npy")
