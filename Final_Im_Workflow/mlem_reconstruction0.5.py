...
X_train = np.load(f"{base_path}/noisy_sinograms_train0.5.npy")
X_val   = np.load(f"{base_path}/noisy_sinograms_val0.5.npy")
X_test  = np.load(f"{base_path}/noisy_sinograms_test0.5.npy")
